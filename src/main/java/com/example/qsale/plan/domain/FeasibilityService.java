...
public class FeasibilityService {
    ...
    public FeasibilityResponseDto getFeasibility(Long planId) {
        ...
        return new FeasibilityResponseDto(plan.getId(), plan.getFeasibilityScore(), plan.getFeasibilityStatus(),
                countConfirmed(planId), plan.getMinParticipants(), participantRepository.countByPlanId(planId));
    }
